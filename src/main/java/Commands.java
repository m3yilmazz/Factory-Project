public class Commands {
    ...
    static final String GET_PENDING_JOB_ORDERS = "GETPENDING";
    static final String GET_MACHINE_STATES = "GETMS";
    static final String GET_PROCESSING_JOB_ORDERS = "GETPROCESSING";
